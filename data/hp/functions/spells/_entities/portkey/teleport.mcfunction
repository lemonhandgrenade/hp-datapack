...
#data modify entity @e[type=armor_stand,tag=new,tag=teleport,limit=1] Pos set from entity @s Item.tag.PortkeyPos
...
#execute as @p[distance=..2] at @s as @a[distance=..2] run tp @s @e[type=armor_stand,tag=new,tag=teleport,limit=1]
#kill @e[type=armor_stand,tag=new,tag=teleport,limit=1]65