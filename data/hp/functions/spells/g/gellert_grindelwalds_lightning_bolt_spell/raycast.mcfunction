...
execute if entity @e[tag=!slowcast,tag=!this,dx=0] positioned ~-0.7 ~-0.7 ~-0.7 if entity @e[tag=!this,dx=0] positioned ~0.7 ~0.7 ~0.7 run function hp:spells/g/gellert_grindelwalds_lightning_bolt_spell/hit_entity
