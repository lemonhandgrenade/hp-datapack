...
execute if score #temp slowcast matches 0.. if score charmsBreakBlocks settings matches 1 positioned ^ ^ ^0.5 if block ~ ~ ~ stone run function hp:spells/g/gouging_spell/destroy
