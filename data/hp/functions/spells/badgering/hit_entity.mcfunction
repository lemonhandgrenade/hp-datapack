...
execute as @a[dx=0,tag=!this] positioned ~-0.99 ~-0.99 ~-0.99 if entity @s[dx=0] positioned ~0.99 ~0.99 ~0.99 run scoreboard players operation @e[type=fox,tag=transfigurationAnimal,tag=new] UID = @s UID
...
execute if entity @s[type=area_effect_cloud] run function hp:spells/b/badgering/private/end