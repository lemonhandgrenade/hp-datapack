...
execute if entity @e[tag=!this,dx=0,tag=levicorpus] positioned ~-0.99 ~-0.99 ~-0.99 if entity @e[tag=!this,dx=0] positioned ~0.99 ~0.99 ~0.99 run function hp:spells/l/liberacorpus/hit_entity
