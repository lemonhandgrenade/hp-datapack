...
execute if score temp values matches 0 if data entity @s {NoGravity:1b} run tag @s add noGravity
...
execute if score temp values matches 1 run data merge entity @s[tag=!noGravity] {NoGravity:0b}