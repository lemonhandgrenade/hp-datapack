...
execute if entity @e[type=#hp:can_hold,tag=!this,dx=0,predicate=hp:player/holding_item] positioned ~-0.99 ~-0.99 ~-0.99 if entity @e[tag=!this,dx=0] positioned ~0.99 ~0.99 ~0.99 run function hp:spells/r/revulsion_jinx/hit_entity
