...
summon armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,Small:1b,Tags:["candleLight","new"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:candle",Count:1b,tag:{CustomModelData:2890}}]}
