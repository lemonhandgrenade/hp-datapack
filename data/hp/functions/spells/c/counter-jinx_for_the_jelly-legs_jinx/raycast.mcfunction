...
execute if entity @e[tag=!this,dx=0,tag=jellyLegs] positioned ~-0.99 ~-0.99 ~-0.99 if entity @e[tag=!this,dx=0] positioned ~0.99 ~0.99 ~0.99 run function hp:spells/c/counter-jinx_for_the_jelly-legs_jinx/hit_entity
