...
execute if entity @e[type=armor_stand,tag=candleLight,tag=!this,dx=0] positioned ~-0.99 ~-0.99 ~-0.99 if entity @e[tag=!this,dx=0] positioned ~0.99 ~0.99 ~0.99 run function hp:spells/c/candle_to_purple_rabbit_spell/transfigure
