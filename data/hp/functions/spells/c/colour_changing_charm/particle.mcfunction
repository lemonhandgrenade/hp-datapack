...
execute if score @s colourChangingCharm matches 1 run particle dust_color_transition 0.66 0 0 1 0.33 0 0 ~ ~ ~ 0 0 0 0 1
...
execute if score @s colourChangingCharm matches 4 run particle dust_color_transition 0.98 0.66 0 1 0.5 0.33 0 ~ ~ ~ 0 0 0 0 1