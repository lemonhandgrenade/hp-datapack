...
execute if entity @e[type=#hp:can_hold,tag=!this,dx=0,predicate=hp:player/holding_item] positioned ~-0.7 ~-0.7 ~-0.7 if entity @e[tag=!this,dx=0] positioned ~0.7 ~0.7 ~0.7 run function hp:spells/j/jelly-fingers_curse/hit_entity
