...
execute if entity @a[tag=!this,dx=0,tag=!hasCold] positioned ~-0.7 ~-0.7 ~-0.7 if entity @a[tag=!this,dx=0] positioned ~0.7 ~0.7 ~0.7 run function hp:spells/m/mucus_ad_nauseam_tria/hit_entity
