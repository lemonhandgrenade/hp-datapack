...
execute if entity @a[tag=!this,dx=0,tag=!hasCold] positioned ~-0.99 ~-0.99 ~-0.99 if entity @a[tag=!this,dx=0] positioned ~0.99 ~0.99 ~0.99 run function hp:spells/m/mucus_ad_nauseam_duo/hit_entity
