...
execute if score @s sloDst matches 1.. run function hp:spells/m/mucus_ad_nauseam_duo/raycast
scoreboard players operation @s sloDst -= @s sloDstPer
execute if score @s sloDst matches ..0 at @s run function hp:spells/m/mucus_ad_nauseam_duo/private/end
