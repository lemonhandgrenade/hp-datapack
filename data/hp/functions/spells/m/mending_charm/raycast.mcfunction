...
execute if score #temp slowcast matches 0.. if entity @e[type=area_effect_cloud,tag=mendingCharm,tag=!this,distance=..0.8,limit=1] run function hp:spells/m/mending_charm/hit_entity
