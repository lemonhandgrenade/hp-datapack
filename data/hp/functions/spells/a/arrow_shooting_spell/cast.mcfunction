...
execute rotated as @p[tag=spellCaster] positioned 0.0 0 0.0 positioned ^ ^ ^1 summon area_effect_cloud run data modify entity @e[type=arrow,tag=new,tag=spellEntity,tag=conjuredEntity,limit=1] Motion set from entity @s Pos
