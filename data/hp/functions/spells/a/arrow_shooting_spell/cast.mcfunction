...
execute as @e[type=arrow,tag=new] store result score @s X run data get entity @s Pos[0] 2000
execute as @e[type=arrow,tag=new] store result score @s Y run data get entity @s Pos[1] 2000
execute as @e[type=arrow,tag=new] store result score @s Z run data get entity @s Pos[2] 2000
