...
execute if entity @e[tag=!this,dx=0,tag=morphed,tag=apparition] positioned ~-0.7 ~-0.7 ~-0.7 if entity @e[tag=!this,dx=0] positioned ~0.7 ~0.7 ~0.7 run function hp:spells/a/anti-disapparition_jinx/hit_entity
