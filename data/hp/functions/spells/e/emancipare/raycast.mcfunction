...
execute if entity @e[tag=!this,dx=0,tag=bound] positioned ~-0.99 ~-0.99 ~-0.99 if entity @e[tag=!this,dx=0] positioned ~0.99 ~0.99 ~0.99 run function hp:spells/e/emancipare/hit_entity
