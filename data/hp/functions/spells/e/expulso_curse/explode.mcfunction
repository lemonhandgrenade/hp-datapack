...
execute as @e[distance=..3.5] run effect give @s minecraft:resistance 1 3 true
...
execute if entity @s[type=area_effect_cloud] run function hp:spells/e/expulso_curse/private/end