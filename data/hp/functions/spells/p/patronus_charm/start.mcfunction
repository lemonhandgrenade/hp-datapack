...
execute if score @s patronusID matches 4 run summon armor_stand ~ ~ ~ {Invisible:1b,NoGravity:1b,Invulnerable:1b,Tags:["spellEntity","patronus","wolf","new","patronusCharm"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:light_blue_stained_glass",Count:1b}]}
