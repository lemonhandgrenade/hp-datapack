...
execute as @a[dx=0,tag=!this] positioned ~-0.7 ~-0.7 ~-0.7 if entity @s[dx=0] positioned ~0.7 ~0.7 ~0.7 run scoreboard players operation @e[type=chicken,tag=transfigurationAnimal,tag=new] UID = @s UID
...
execute if entity @s[type=area_effect_cloud] run function hp:spells/p/pullus/private/end