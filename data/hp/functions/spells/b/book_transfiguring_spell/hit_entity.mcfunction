execute as @e[type=item,dx=0,tag=!this,nbt={Item:{id:"minecraft:written_book"}}] positioned ~-0.99 ~-0.99 ~-0.99 if entity @s[dx=0] positioned ~0.99 ~0.99 ~0.99 run tag @s add effected
