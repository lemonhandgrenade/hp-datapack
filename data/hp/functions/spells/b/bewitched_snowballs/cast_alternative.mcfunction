execute rotated as @s positioned 0 0 0 align xyz positioned ^ ^ ^0.5 run summon marker ~ ~ ~ {Tags:["new","bewitchedSnowballMarker"]}
summon snowball ~ ~1.45 ~ {Owner:[I;1,1,1,1],Tags:["new","spellEntity","conjuredEntity","level1"]}
