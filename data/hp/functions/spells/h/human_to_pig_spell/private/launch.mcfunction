...
execute if score @s sloDst matches 1.. run function hp:spells/h/human_to_pig_spell/raycast
scoreboard players operation @s sloDst -= @s sloDstPer
execute if score @s sloDst matches ..0 at @s run function hp:spells/h/human_to_pig_spell/private/end
