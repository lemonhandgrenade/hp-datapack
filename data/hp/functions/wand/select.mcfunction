...
execute if score @s spell matches 469..541 run function hp:spells/s/_select
execute if score @s spell matches 542..577 run function hp:spells/t/_select
execute if score @s spell matches 578..586 run function hp:spells/u/_select
execute if score @s spell matches 587..603 run function hp:spells/v/_select
execute if score @s spell matches 604..619 run function hp:spells/w/_select
execute if score @s spell matches 620..620 run function hp:spells/y/_select
