...
execute if score @s spell matches 469..542 run function hp:spells/s/_select_alternative
execute if score @s spell matches 543..578 run function hp:spells/t/_select_alternative
execute if score @s spell matches 579..587 run function hp:spells/u/_select_alternative
execute if score @s spell matches 588..604 run function hp:spells/v/_select_alternative
execute if score @s spell matches 605..620 run function hp:spells/w/_select_alternative
execute if score @s spell matches 621..621 run function hp:spells/y/_select_alternative
