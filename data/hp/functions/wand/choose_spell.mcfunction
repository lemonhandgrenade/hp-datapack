...
execute if score temp values matches 3..4 run scoreboard players set @s currentSpellSlot 1
...
execute if score @s sneakTest matches 1.. if score temp values matches 4 run scoreboard players set @s currentSpellSlot 3
execute if score @s sneakTest matches 1.. if score temp values matches 3 run scoreboard players set @s currentSpellSlot 4
