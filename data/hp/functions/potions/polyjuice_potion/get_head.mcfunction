...
execute if score #P0 UID = #0 UID if score #P1 UID = #1 UID if score #P2 UID = #2 UID if score #P3 UID = #3 UID run loot replace block 0 -64 0 container.0 loot hp:player_head
