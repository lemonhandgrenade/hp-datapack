...
execute as @e[type=item,tag=!expelled,nbt={OnGround:0b,Item:{tag:{Wand:1b}}}] at @s unless entity @p[x_rotation=90] unless entity @p[predicate=hp:player/dead] run function hp:wand/change_spell
