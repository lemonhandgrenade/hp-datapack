...
execute unless block ~ ~-0.2 ~ air if score @s Y matches 1..625 run data modify entity @s ArmorItems[3].tag.CustomModelData set value 1051
execute unless block ~ ~-0.2 ~ air if score @s Y matches 626.. run data modify entity @s ArmorItems[3].tag.CustomModelData set value 1052