...
data modify block 0 0 0 Items append from storage hp:armor HeadItem
...
data modify block 0 0 0 Items append from storage hp:armor ChestItem
...
data modify block 0 0 0 Items append from storage hp:armor LegsItem
...
data modify block 0 0 0 Items append from storage hp:armor FeetItem

## GIVE BACK ITEMS
loot give @s mine 0 0 0 minecraft:air{drop_contents:1b}
