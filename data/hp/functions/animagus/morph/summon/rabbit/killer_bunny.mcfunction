summon rabbit ~ ~ ~ {NoAI:1b,OnGround:0b,NoGravity:1b,Invulnerable:1b,CustomNameVisible:0b,Team:"noCollision",RabbitType:99,Tags:["animagusCreature","new"],CustomName:'{"translate":"animagus.hp.rabbit_killer"}'}
