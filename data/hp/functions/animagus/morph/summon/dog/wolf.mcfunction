summon wolf ~ ~ ~ {Invulnerable:1b,NoAI:1b,Owner:[I;0,0,0,0],Tags:["animagusCreature","new"],CustomNameVisible:0b,CustomName:'{"translate":"animagus.hp.dog_wolf"}',Team:"noCollision"}
