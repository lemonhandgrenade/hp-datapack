summon cat ~ ~ ~ {CustomNameVisible:0,CustomName:'{"translate":"animagus.hp.cat_ragdoll"}',Invulnerable:1b,CatType:7,Tags:["animagusCreature","new"],Team:"noCollision",NoAI:1b}
