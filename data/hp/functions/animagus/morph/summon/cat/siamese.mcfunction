summon cat ~ ~ ~ {CustomNameVisible:0,CustomName:'{"translate":"animagus.hp.cat_siamese"}',Invulnerable:1b,CatType:3,Tags:["animagusCreature","new"],Team:"noCollision",NoAI:1b}
