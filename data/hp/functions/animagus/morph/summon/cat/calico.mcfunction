summon cat ~ ~ ~ {CustomNameVisible:0,CustomName:'{"translate":"animagus.hp.cat_calico"}',Invulnerable:1b,CatType:5,Tags:["animagusCreature","new"],Team:"noCollision",NoAI:1b}
