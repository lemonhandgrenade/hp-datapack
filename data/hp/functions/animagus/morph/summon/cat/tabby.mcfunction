summon cat ~ ~ ~ {CustomNameVisible:0,CustomName:'{"translate":"animagus.hp.cat_tabby"}',Invulnerable:1b,CatType:0,Tags:["animagusCreature","new"],Team:"noCollision",NoAI:1b}
