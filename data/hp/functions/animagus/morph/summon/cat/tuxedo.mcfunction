summon cat ~ ~ ~ {CustomNameVisible:0,CustomName:'{"translate":"animagus.hp.cat_tuxedo"}',Invulnerable:1b,CatType:1,Tags:["animagusCreature","new"],Team:"noCollision",NoAI:1b}
