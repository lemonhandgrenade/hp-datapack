summon cat ~ ~ ~ {CustomNameVisible:0,CustomName:'{"translate":"animagus.hp.cat_british_shorthair"}',Invulnerable:1b,CatType:4,Tags:["animagusCreature","new"],Team:"noCollision",NoAI:1b}
