summon cat ~ ~ ~ {CustomNameVisible:0,CustomName:'{"translate":"animagus.hp.cat_jellie"}',Invulnerable:1b,CatType:9,Tags:["animagusCreature","new"],Team:"noCollision",NoAI:1b}
