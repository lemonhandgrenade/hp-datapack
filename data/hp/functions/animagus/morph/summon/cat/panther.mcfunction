summon cat ~ ~ ~ {CustomNameVisible:0,CustomName:'{"translate":"animagus.hp.cat_panther"}',Invulnerable:1b,CatType:10,Tags:["animagusCreature","new"],Team:"noCollision",NoAI:1b}
