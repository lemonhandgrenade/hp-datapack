...
scoreboard players operation temp values = amount activeDuels
scoreboard players remove temp values 1

tag @s add duelling

scoreboard players set #modify values 30
scoreboard players operation #modify values *= temp values

scoreboard players set #x values 14

scoreboard players operation #x values += #modify values


#execute at @s in hp:void run function hp:player/duel/tpx
tp @s 0 5 21
