...
execute if score easySortingHat settings matches 1 run tellraw @s {"nbt":"Questions[26][1]","storage":"hp:sorting_hat","color":"#805555","clickEvent":{"action":"run_command","value":"/trigger quizTrigger set 875822"}}
execute if score easySortingHat settings matches 1 run tellraw @s {"nbt":"Questions[26][2]","storage":"hp:sorting_hat","color":"#555500","clickEvent":{"action":"run_command","value":"/trigger quizTrigger set 903591"}}